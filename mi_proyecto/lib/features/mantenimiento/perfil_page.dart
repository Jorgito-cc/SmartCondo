...
// 👇 ajusta esta ruta a donde esté tu login
...
class _PerfilPageState extends State<PerfilPage> {
  ...
  // 👇 Logout: limpia prefs y navega al Login eliminando el historial
          ...
          return RefreshIndicator(
            ...
            child: ListView(
              ...
              children: [
                ...
                if (u.rolNombre != null)
                  Center(child: Text(u.rolNombre!, style: Theme.of(context).textTheme.bodyMedium)),
